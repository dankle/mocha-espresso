...
var initSettings = function() {
  // Get config file from main app
  var config = require(process.cwd() + '/config/mocha-espresso.json');
  if(config) {
...
var parseResultFile = function(finalJSONreportName, passed, callback) {
  var json_path = Path.join(__dirname, '..', 'test', 'reports', finalJSONreportName);
...
// Main method
var mochaEspressoMain = function () {
