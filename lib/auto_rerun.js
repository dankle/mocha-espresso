...
Rerun.reRunMain = function(xml_name, json_name, rerun, rerun_count, mocha_test_folder, report_dir, callback) {
  report_directory = report_dir;
  createFinalReportFiles(json_name, function() {
    if(rerun) {
      rerun_times = rerun_count;
      run_path = mocha_test_folder;
      reRun(xml_name, json_name, json_name, 0, false, function(rerunFailed, finalReportName) {
...
var reRun = function(xml_name, json_name, originalFileName, loop, rerunFailed, callback) {
  ...
  if (loop < rerun_times) {
    ...
    if (failedTestsArray.length !== 0) {
      ...
      var reRunCmd = 'mocha --no-colors -R json --recursive --slow 5000 ' +
